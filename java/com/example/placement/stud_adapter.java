...
public class stud_adapter extends RecyclerView.Adapter<stud_adapter.MyViewHolder>
{

    ArrayList<jobs> list;
    ArrayList<String> keys;
    public stud_adapter(ArrayList<jobs> list,ArrayList<String> keys)
    {
        this.list=list;
        this.keys=keys;
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull final View itemView) {
            super(itemView);
            title=itemView.findViewById(R.id.jid);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(v.getContext(),stud_job_desc.class);
